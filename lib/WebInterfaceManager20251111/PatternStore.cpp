...
constexpr DefaultPattern kDefaultPatterns[] = {
    {"1", "Smooth Orbit", 18.f, 14.f, 9.f, 12.f, 0.6f, 0.f, 0.f, 22.f, 24, 4.f, 3.5f, 2.5f, 22.f, 20.f},
    {"2", "Slow Breathing", 30.f, 28.f, 16.f, 8.f, 0.3f, 0.f, 0.f, 18.f, 28, 2.f, 2.f, 2.f, 32.f, 34.f},
    {"3", "Rapid Sparks", 8.f, 6.f, 4.f, 20.f, 1.2f, 0.f, 0.f, 10.f, 14, 6.f, 5.f, 7.f, 9.f, 11.f},
    {"4", "Wide Sweep", 20.f, 18.f, 11.f, 12.f, 0.6f, 6.f, -4.f, 40.f, 48, 3.f, 8.f, 5.f, 26.f, 24.f},
    {"5", "Calm Center", 24.f, 18.f, 6.f, 4.f, 0.2f, 0.f, 0.f, 8.f, 12, 1.5f, 1.5f, 1.5f, 40.f, 36.f}
};
